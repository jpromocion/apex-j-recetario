...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12443705556418254)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12444035146418254)
,p_plug_template_id=>wwv_flow_imp.id(12443705556418254)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12444301571418254)
,p_plug_template_id=>wwv_flow_imp.id(12443705556418254)
,p_name=>'Sub Regions'
