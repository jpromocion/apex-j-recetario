...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12415124180418236)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12415401756418236)
,p_page_template_id=>wwv_flow_imp.id(12415124180418236)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12415749138418237)
,p_page_template_id=>wwv_flow_imp.id(12415124180418236)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12416081933418237)
,p_page_template_id=>wwv_flow_imp.id(12415124180418236)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12416390131418237)
,p_page_template_id=>wwv_flow_imp.id(12415124180418236)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12416681106418237)
,p_page_template_id=>wwv_flow_imp.id(12415124180418236)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12416994363418237)
,p_page_template_id=>wwv_flow_imp.id(12415124180418236)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12417211941418237)
,p_page_template_id=>wwv_flow_imp.id(12415124180418236)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12417529819418237)
,p_page_template_id=>wwv_flow_imp.id(12415124180418236)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12417820496418238)
,p_page_template_id=>wwv_flow_imp.id(12415124180418236)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12418126644418238)
,p_page_template_id=>wwv_flow_imp.id(12415124180418236)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12418492137418238)
,p_page_template_id=>wwv_flow_imp.id(12415124180418236)
