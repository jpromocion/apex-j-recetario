...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12403673113418230)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12403980923418230)
,p_page_template_id=>wwv_flow_imp.id(12403673113418230)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12404224948418230)
,p_page_template_id=>wwv_flow_imp.id(12403673113418230)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12404578308418230)
,p_page_template_id=>wwv_flow_imp.id(12403673113418230)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12404819344418230)
,p_page_template_id=>wwv_flow_imp.id(12403673113418230)
,p_name=>'Body Footer'
