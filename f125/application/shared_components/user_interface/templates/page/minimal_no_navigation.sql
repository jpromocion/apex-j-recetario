...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12410211772418234)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12410564367418234)
,p_page_template_id=>wwv_flow_imp.id(12410211772418234)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12410838006418234)
,p_page_template_id=>wwv_flow_imp.id(12410211772418234)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12411172886418234)
,p_page_template_id=>wwv_flow_imp.id(12410211772418234)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12411432949418234)
,p_page_template_id=>wwv_flow_imp.id(12410211772418234)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12411702555418235)
,p_page_template_id=>wwv_flow_imp.id(12410211772418234)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12412009223418235)
,p_page_template_id=>wwv_flow_imp.id(12410211772418234)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12412300849418235)
,p_page_template_id=>wwv_flow_imp.id(12410211772418234)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12412698765418235)
,p_page_template_id=>wwv_flow_imp.id(12410211772418234)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12412938111418235)
,p_page_template_id=>wwv_flow_imp.id(12410211772418234)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12413235815418235)
,p_page_template_id=>wwv_flow_imp.id(12410211772418234)
