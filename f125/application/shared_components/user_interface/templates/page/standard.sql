...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12418865527418238)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12419156665418238)
,p_page_template_id=>wwv_flow_imp.id(12418865527418238)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12419412373418238)
,p_page_template_id=>wwv_flow_imp.id(12418865527418238)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12419702645418238)
,p_page_template_id=>wwv_flow_imp.id(12418865527418238)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12420072762418239)
,p_page_template_id=>wwv_flow_imp.id(12418865527418238)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12420375371418239)
,p_page_template_id=>wwv_flow_imp.id(12418865527418238)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12420638762418239)
,p_page_template_id=>wwv_flow_imp.id(12418865527418238)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12420916969418239)
,p_page_template_id=>wwv_flow_imp.id(12418865527418238)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12421203826418239)
,p_page_template_id=>wwv_flow_imp.id(12418865527418238)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12421537872418239)
,p_page_template_id=>wwv_flow_imp.id(12418865527418238)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12421808677418239)
,p_page_template_id=>wwv_flow_imp.id(12418865527418238)
