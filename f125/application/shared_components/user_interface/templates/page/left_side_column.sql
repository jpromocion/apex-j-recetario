...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(12395935425418225)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12396214537418226)
,p_page_template_id=>wwv_flow_imp.id(12395935425418225)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12396580771418226)
,p_page_template_id=>wwv_flow_imp.id(12395935425418225)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12396840340418226)
,p_page_template_id=>wwv_flow_imp.id(12395935425418225)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12397143280418226)
,p_page_template_id=>wwv_flow_imp.id(12395935425418225)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12397414209418226)
,p_page_template_id=>wwv_flow_imp.id(12395935425418225)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12397761127418227)
,p_page_template_id=>wwv_flow_imp.id(12395935425418225)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12398085779418227)
,p_page_template_id=>wwv_flow_imp.id(12395935425418225)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12398302476418227)
,p_page_template_id=>wwv_flow_imp.id(12395935425418225)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12398623197418227)
,p_page_template_id=>wwv_flow_imp.id(12395935425418225)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12398992964418227)
,p_page_template_id=>wwv_flow_imp.id(12395935425418225)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12399285107418227)
,p_page_template_id=>wwv_flow_imp.id(12395935425418225)
