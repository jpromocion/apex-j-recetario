...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12487110258418274)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12487434692418275)
,p_plug_template_id=>wwv_flow_imp.id(12487110258418274)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12487785441418275)
,p_plug_template_id=>wwv_flow_imp.id(12487110258418274)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12488052687418275)
,p_plug_template_id=>wwv_flow_imp.id(12487110258418274)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12488322095418275)
,p_plug_template_id=>wwv_flow_imp.id(12487110258418274)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12488677927418275)
,p_plug_template_id=>wwv_flow_imp.id(12487110258418274)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12488971690418276)
,p_plug_template_id=>wwv_flow_imp.id(12487110258418274)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12489279058418276)
,p_plug_template_id=>wwv_flow_imp.id(12487110258418274)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12489505728418276)
,p_plug_template_id=>wwv_flow_imp.id(12487110258418274)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12489829775418276)
,p_plug_template_id=>wwv_flow_imp.id(12487110258418274)
,p_name=>'Sub Regions'
