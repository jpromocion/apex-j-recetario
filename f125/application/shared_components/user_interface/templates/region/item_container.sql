...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12456055600418260)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12456331238418260)
,p_plug_template_id=>wwv_flow_imp.id(12456055600418260)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12456620284418260)
,p_plug_template_id=>wwv_flow_imp.id(12456055600418260)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12456911428418260)
,p_plug_template_id=>wwv_flow_imp.id(12456055600418260)
,p_name=>'Button Start'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12890843492453079)
,p_plug_template_id=>wwv_flow_imp.id(12456055600418260)
,p_name=>'Sub Regions'
