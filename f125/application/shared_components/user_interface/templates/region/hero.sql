...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12496653443418281)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12496910730418282)
,p_plug_template_id=>wwv_flow_imp.id(12496653443418281)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12497255342418282)
,p_plug_template_id=>wwv_flow_imp.id(12496653443418281)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12497564527418283)
,p_plug_template_id=>wwv_flow_imp.id(12496653443418281)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12497841964418283)
,p_plug_template_id=>wwv_flow_imp.id(12496653443418281)
,p_name=>'Sub Regions'
