...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12431757393418247)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12432027930418248)
,p_plug_template_id=>wwv_flow_imp.id(12431757393418247)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12432363111418248)
,p_plug_template_id=>wwv_flow_imp.id(12431757393418247)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12432664451418248)
,p_plug_template_id=>wwv_flow_imp.id(12431757393418247)
,p_name=>'Sub Regions'
