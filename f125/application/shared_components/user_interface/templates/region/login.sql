...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12504235741418286)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12504510158418286)
,p_plug_template_id=>wwv_flow_imp.id(12504235741418286)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12504803724418286)
,p_plug_template_id=>wwv_flow_imp.id(12504235741418286)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12505133631418286)
,p_plug_template_id=>wwv_flow_imp.id(12504235741418286)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12505414943418287)
,p_plug_template_id=>wwv_flow_imp.id(12504235741418286)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12505784060418287)
,p_plug_template_id=>wwv_flow_imp.id(12504235741418286)
,p_name=>'Sub Regions'
