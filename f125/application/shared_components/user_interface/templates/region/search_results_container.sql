...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12458569771418261)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12458816675418261)
,p_plug_template_id=>wwv_flow_imp.id(12458569771418261)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12459169604418261)
,p_plug_template_id=>wwv_flow_imp.id(12458569771418261)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12459461873418261)
,p_plug_template_id=>wwv_flow_imp.id(12458569771418261)
,p_name=>'Sub Regions'
