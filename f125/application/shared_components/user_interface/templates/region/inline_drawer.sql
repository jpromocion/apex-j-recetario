...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(12449126237418256)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12449460491418257)
,p_plug_template_id=>wwv_flow_imp.id(12449126237418256)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12449730268418257)
,p_plug_template_id=>wwv_flow_imp.id(12449126237418256)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12450055843418257)
,p_plug_template_id=>wwv_flow_imp.id(12449126237418256)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12450336958418257)
,p_plug_template_id=>wwv_flow_imp.id(12449126237418256)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12450619589418257)
,p_plug_template_id=>wwv_flow_imp.id(12449126237418256)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12450910996418257)
,p_plug_template_id=>wwv_flow_imp.id(12449126237418256)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12451255382418257)
,p_plug_template_id=>wwv_flow_imp.id(12449126237418256)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(12451544009418258)
,p_plug_template_id=>wwv_flow_imp.id(12449126237418256)
,p_name=>'Sub Regions'
